...
class Config:
    def __init__(self, protoc_file:str, csharp_protoc_file:str, proto_src_dir: str, ignore_file_list: list, special_file_list: list, descriptor_out_file: str,cmdcode_out_file: str):
                #  csharp_out_dir: str, csharp_cmd_file: str, cmdcode_out_file: str):
